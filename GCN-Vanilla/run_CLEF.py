...
renumbered = 'data/clef/predictions/renumbered/'
# read the config file
config = configparser.ConfigParser()
config.read('configs/clef.ini')
...
if test:
    ...
    if binary:
        ...
        #                              config['GCN_MODELS']['model'], config['GCN_MODELS']['window_size'], segment,
        ...
        re_number.append(config['PREDICTIONS']['binary_predictions'], renumbered)
        CLEF_convert.convert(renumbered, config['PREDICTIONS']['final_predictions'])
